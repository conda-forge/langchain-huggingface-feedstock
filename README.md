About langchain-huggingface-feedstock
=====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/langchain-huggingface-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/langchain-huggingface-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add langchain-huggingface
# for installing globally
pixi global install langchain-huggingface
```
...
It is possible to list all of the versions of `langchain-huggingface` available on your platform:
...
```
pixi search langchain-huggingface --channel conda-forge
```
